...
call mvn validate -Didempiere.target=cop.request.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=cop.request.p2.targetplatform %DEBUG_MODE%
