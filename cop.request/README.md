...
- New callout
    * Name: CName
    * Package: cop.request.callout
    * Example: cop.request.callout.CStringFormat

- New process
    * Name: PName
    * Package: cop.request.process
    * Example: cop.request.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: cop.request.form
    * Example: cop.request.form.FMultiPayment

- New event
    * Name: EName
    * Package: cop.request.event
    * Example: cop.request.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: cop.request.model
    * Example: cop.request.model.MTableExample
...
- New callout
    * Create callout in package `cop.request.callout`, extends from `CustomCallout`
    * Register callout in `cop.request.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `cop.request.process`, extends from `CustomProcess`
    * Register process in `cop.request.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `cop.request.form`, extends from `CustomForm`
    * Register form in `cop.request.component.FormFactory`. Example:
...
- New event
    * Create event in package `cop.request.event`, extends from `CustomEvent`
    * Register event in `cop.request.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `cop.request.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `cop.request.component.ModelFactory`. Example:
